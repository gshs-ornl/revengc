...
rnames<-findtypeofcensoring_univariatetable(row_marginal(censoredtable))$Type_of_Censoring
cnames<-findtypeofcensoring_univariatetable(column_marginal(censoredtable))$Type_of_Censoring
# tn = table names
...
rnumb<-findtypeofcensoring_univariatetable(row_marginal(censoredtable))$Censor_Number
cnumb<-findtypeofcensoring_univariatetable(column_marginal(censoredtable))$Censor_Number
...
repx<-fixdata_univariatecase(row_marginal(censoredtable), Xupperbound, 1)
repy<-fixdata_univariatecase(column_marginal(censoredtable),Yupperbound, 1)
